            ...
            <table align="center">
               <tr>
                    ...
                    <td class="auto-style5">
                        <asp:TextBox ID="txtName" runat="server" placeholder="Enter your Name" Width="201px" Height="30px" OnTextChanged="txtName_TextChanged"></asp:TextBox></td>
                </tr>
                 <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style7">
                        <asp:Button ID="btnReg" runat="server" Text="Register" OnClick="btnReg_Click" Height="39px" Width="98px" />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="clear" Height="39px" Width="98px" />
                    </td>
                </tr>
            </table>
        </div>
